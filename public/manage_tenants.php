  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="fa fa-users" aria-hidden="true"></span> Tenants<small> Manage Tenants</small></h1>
          </div>
          ...
          <div class="col-md-12">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title" id="noPrint">Managing Our Tenants  <i class="fa fa-spinner fa-pulse fa-fw"></i> </h3>
              </div>
  ...
  <button type="button" class="btn btn-info btn-flat btn-pri" onclick="window.print()" id="noPrint"><i class="fa fa-print" aria-hidden="true">
          ...
          <tbody id="myTable">        
                      ...
                      <tr>
                        ...
                        <td><?php echo $row["depo_amount"]; ?></td>
