...
<style media="print">
  ...
  <body>
    ...
    <header id="header">
      <div class="container">
        <div class="row">
          <div class="col-md-10">
            <h1><span class="fa fa-users" aria-hidden="true"></span> landlords<small> Manage landlords</small></h1>
          </div>
          ...
          <div class="col-md-12">
            ...
            <div class="panel panel-default">
              <div class="panel-heading main-color-bg">
                <h3 class="panel-title" id="noPrint">Managing Our Landlords  <i class="fa fa-spinner fa-pulse fa-fw"></i> </h3>
              </div>
  ...
  <button type="button" class="btn btn-info btn-flat btn-pri" onclick="window.print()" id="noPrint"><i class="fa fa-print" aria-hidden="true">
          ...
          <tbody id="myTable">        
                      <?php
                      $count = 1;
                      $sel_query = "SELECT * FROM landlords  ORDER BY landlord_id Asc; ";
                      ...
                      <tr>
                        ...
                        <td id="noPrint"><a href="edit_landlord.php?id=<?php echo $row["landlord_id"]; ?>"class="btn btn-default"> <i class="fa fa-pencil"></i> Edit</a> </td>
                        <td id="noPrint"><a href="delete_landlord.php?id=<?php echo $row["landlord_id"]; ?>"class="btn btn-warning"> <i class="fa fa-trash"></i> Delete </a> </td>
                      </tr>
                       <?php $count++;
                    } ?>
                      </tbody>
